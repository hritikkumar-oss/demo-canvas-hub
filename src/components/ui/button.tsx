  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        outline:
          "border border-primary text-primary bg-background hover:bg-primary hover:text-primary-foreground rounded-full",
        secondary:
        ...
        hero: "bg-hero text-hero-foreground hover:bg-hero-hover rounded-full shadow-lg hover:shadow-xl transform hover:scale-105",
        pill: "bg-primary text-primary-foreground hover:bg-primary-hover rounded-full px-6",
      },
      size: {
